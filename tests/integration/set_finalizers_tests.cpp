...
BOOST_FIXTURE_TEST_CASE(set_finalizers_test, tester) try {
    ...
    const std::vector<uint8_t> G1 = {0x16, 0x0c, 0x53, 0xfd, 0x90, 0x87, 0xb3, 0x5c, 
    ...
    BOOST_CHECK(finalizers[0].public_key == *reinterpret_cast<std::array<unsigned char, 144>*>(G1.data()) );
