 ...
 * @ingroup c_api
 * @brief Defines API for querying call and making call
 */
 ...
 *  @return -1 if the receiver does not support sync call, otherwise
 *  @return the number of bytes of the return value of the call
 *
 */
 ...
 * or parent call using `set_call_return_value`
 *
